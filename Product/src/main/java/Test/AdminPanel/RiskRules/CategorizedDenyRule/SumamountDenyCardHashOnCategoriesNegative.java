...
public class SumamountDenyCardHashOnCategoriesNegative extends TestBase{	
	//All test cases will fail, as card hash is same
	/*@Test(description = "Sumamount on Card Hash: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_deny_cardHash_travel_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on Card Hash: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_deny_cardHash_apparel_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on Card Hash: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_deny_cardHash_electronics_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on Card Hash: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_deny_cardHash_games_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on Card Hash: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_deny_cardHash_digital_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on Card Hash: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_deny_cardHash_other_negative_rule(Config testConfig) {
