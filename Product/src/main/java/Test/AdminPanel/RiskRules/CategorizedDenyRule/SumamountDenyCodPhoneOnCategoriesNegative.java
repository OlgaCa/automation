...
public class SumamountDenyCodPhoneOnCategoriesNegative extends TestBase{
	//Test cases will always fail as cod transactions without zipdial page, do not hit the rule. redmine is already raised
	/*@Test(description = "Sumamount on Cod Phone: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_deny_CodPhone_travel_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on Cod Phone: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_deny_CodPhone_apparel_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on Cod Phone: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_deny_CodPhone_electronics_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on Cod Phone: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_deny_CodPhone_games_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on Cod Phone: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_deny_CodPhone_digital_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on Cod Phone: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_deny_CodPhone_other_negative_rule(Config testConfig) {
