...
public class MaxcountDenyCodPhoneOnCategories extends TestBase{
	//Test cases will always fail as cod transactions without zipdial page, do not hit the rule. redmine is already raised
	/*@Test(description = "MaxCount on codphone: Creating a Rule in all categories and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxcount_deny_codphone_rule_travel(Config testConfig) {
	...
	@Test(description = "MaxCount on codphone: Creating a Rule in all categories and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxcount_deny_codphone_rule_apparel(Config testConfig) {
	...
	@Test(description = "MaxCount on codphone: Creating a Rule in all categories and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxcount_deny_codphone_rule_electronics(Config testConfig) {
	...
	@Test(description = "MaxCount on codphone: Creating a Rule in all categories and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxcount_deny_codphone_rule_games(Config testConfig) {
	...
	@Test(description = "MaxCount on codphone: Creating a Rule in all categories and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxcount_deny_codphone_rule_digital(Config testConfig) {
	...
	@Test(description = "MaxCount on codphone: Creating a Rule in all categories and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxcount_deny_codphone_rule_others(Config testConfig) {
