...
public class CcHashDenyOnCategories extends TestBase{
	//CChash on PP doesn't work
	/*@Test(description = "CCHash: Creating a Rule in all categories and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void CCHash_deny_rule_travel(Config testConfig) {
	...
	@Test(description = "CCHash: Creating a Rule in all categories and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void CCHash_deny_rule_apparel(Config testConfig) {
	...
	@Test(description = "CCHash: Creating a Rule in all categories and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void CCHash_deny_rule_electronics(Config testConfig) {
	...
	@Test(description = "CCHash: Creating a Rule in all categories and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void CCHash_deny_rule_games(Config testConfig) {
	...
	@Test(description = "CCHash: Creating a Rule in all categories and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void CCHash_deny_rule_digital(Config testConfig) {
	...
	@Test(description = "CCHash: Creating a Rule in all categories and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void CCHash_deny_rule_others(Config testConfig) {
