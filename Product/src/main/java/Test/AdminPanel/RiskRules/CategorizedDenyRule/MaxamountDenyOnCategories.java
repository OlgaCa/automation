...
public class MaxamountDenyOnCategories extends TestBase{
	@Test(description = "Maxamount: Creating a Rule in travel category  and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxamount_deny_rule_travel(Config testConfig) {
	...
	@Test(description = "Maxamount: Creating a Rule in apparel category and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxamount_deny_rule_apparel(Config testConfig) {
	...
	@Test(description = "Maxamount: Creating a Rule in electronics category and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxamount_deny_rule_electronics(Config testConfig) {
	...
	@Test(description = "Maxamount: Creating a Rule in games category and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxamount_deny_rule_games(Config testConfig) {
	...
	/*@Test(description = "Maxamount: Creating a Rule in digital category and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxamount_deny_rule_digital(Config testConfig) {
	...
	@Test(description = "Maxamount: Creating a Rule in others category and do the transaction to check it should hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxamount_deny_rule_others(Config testConfig) {
