...
public class MaxcountDenyCardHashOnCategoriesNegative extends TestBase{	
	//Test cases will always fail as this cardhash has been used multiple times
	/*@Test(description = "Maxcount on Card Hash: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxcount_deny_cardHash_travel_negative_rule(Config testConfig) {
	...
	@Test(description = "Maxcount on Card Hash: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxcount_deny_cardHash_apparel_negative_rule(Config testConfig) {
	...
	@Test(description = "Maxcount on Card Hash: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxcount_deny_cardHash_electronics_negative_rule(Config testConfig) {
	...
	@Test(description = "Maxcount on Card Hash: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxcount_deny_cardHash_games_negative_rule(Config testConfig) {
	...
	@Test(description = "Maxcount on Card Hash: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxcount_deny_cardHash_digital_negative_rule(Config testConfig) {
	...
	@Test(description = "Maxcount on Card Hash: Creating a Rule in all categories and do the transaction only once to check it should not hit deny rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxcount_deny_cardHash_other_negative_rule(Config testConfig) {
