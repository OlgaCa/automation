...
public class MaxamountChallengeOnCategoriesNegative extends TestBase{	
	...
	public void Maxamount_Challenge_travel_negative_rule(Config testConfig) {
	...
	@Test(description = "Maxcount on Card Hash: Creating a Rule in apparel category and do the transaction only once to check it should not hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxamount_Challenge_apparel_negative_rule(Config testConfig) {
	...
	@Test(description = "Maxcount on Card Hash: Creating a Rule in electronic category and do the transaction only once to check it should not hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxamount_Challenge_electronics_negative_rule(Config testConfig) {
	...
	@Test(description = "Maxcount on Card Hash: Creating a Rule in games category and do the transaction only once to check it should not hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxamount_Challenge_games_negative_rule(Config testConfig) {
	...
	@Test(description = "Maxcount on Card Hash: Creating a Rule in digital category and do the transaction only once to check it should not hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxamount_Challenge_digital_negative_rule(Config testConfig) {
	...
	@Test(description = "Maxcount on Card Hash: Creating a Rule in other category and do the transaction only once to check it should not hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Maxamount_Challenge_other_negative_rule(Config testConfig) {
