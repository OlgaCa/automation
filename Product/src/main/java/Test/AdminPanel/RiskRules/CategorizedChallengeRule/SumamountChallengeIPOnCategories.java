...
public class SumamountChallengeIPOnCategories extends TestBase{
	//All test cases will fail, as IP is same
		
	/*@Test(description = "Sumamount on IP: Creating a Rule in all categories and do the transaction to check it should hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_IP_rule_travel(Config testConfig) {
	...
	@Test(description = "Sumamount on IP: Creating a Rule in all categories and do the transaction to check it should hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_IP_rule_apparel(Config testConfig) {
	...
	@Test(description = "Sumamount on IP: Creating a Rule in all categories and do the transaction to check it should hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_IP_rule_electronics(Config testConfig) {
	...
	@Test(description = "Sumamount on IP: Creating a Rule in all categories and do the transaction to check it should hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_IP_rule_games(Config testConfig) {
	...
	@Test(description = "Sumamount on IP: Creating a Rule in all categories and do the transaction to check it should hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_IP_rule_digital(Config testConfig) {
	...
	@Test(description = "Sumamount on IP: Creating a Rule in all categories and do the transaction to check it should hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_IP_rule_others(Config testConfig) {
