...
public class SumamountChallengeCodPhoneOnCategories extends TestBase{
	
	//Test cases will always fail as cod Phone for challenge has not been implemented
	/*@Test(description = "Sumamount on codphone: Creating a Rule in all categories and do the transaction to check it should hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_codphone_rule_travel(Config testConfig) {
	...
	@Test(description = "Sumamount on codphone: Creating a Rule in all categories and do the transaction to check it should hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_codphone_rule_apparel(Config testConfig) {
	...
	@Test(description = "Sumamount on codphone: Creating a Rule in all categories and do the transaction to check it should hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_codphone_rule_electronics(Config testConfig) {
	...
	@Test(description = "Sumamount on codphone: Creating a Rule in all categories and do the transaction to check it should hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_codphone_rule_games(Config testConfig) {
	...
	@Test(description = "Sumamount on codphone: Creating a Rule in all categories and do the transaction to check it should hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_codphone_rule_digital(Config testConfig) {
	...
	@Test(description = "Sumamount on codphone: Creating a Rule in all categories and do the transaction to check it should hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_codphone_rule_others(Config testConfig) {
