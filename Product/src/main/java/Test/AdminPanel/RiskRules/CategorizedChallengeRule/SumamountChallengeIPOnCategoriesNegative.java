...
public class SumamountChallengeIPOnCategoriesNegative extends TestBase{	

	//All test cases will fail as IP is same

	/*@Test(description = "Sumamount on IP: Creating a Rule in all categories and do the transaction only once to check it should not hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_IP_travel_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on IP: Creating a Rule in all categories and do the transaction only once to check it should not hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_IP_apparel_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on IP: Creating a Rule in all categories and do the transaction only once to check it should not hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_IP_electronics_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on IP: Creating a Rule in all categories and do the transaction only once to check it should not hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_IP_games_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on IP: Creating a Rule in all categories and do the transaction only once to check it should not hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_IP_digital_negative_rule(Config testConfig) {
	...
	@Test(description = "Sumamount on IP: Creating a Rule in all categories and do the transaction only once to check it should not hit Challenge rule",
			dataProvider="GetTestConfig", timeOut=600000, groups="1")
	public void Sumamount_Challenge_IP_other_negative_rule(Config testConfig) {
