...
public class TestRequestCapture extends TestBase{


	//public TransactionPage trans;

	//public void test_VerifyCITITransaction(Config testConfig) - moved to LiveCard TestCases -9
	...
	//public void VerifyFirstRowexportExcel(Config testConfig) throws Exception - moved to LoveCard TestCases -8
	// 	public void test_VerifyAuthTransaction(Config testConfig) - moved to LiveCard TestCases - 7
